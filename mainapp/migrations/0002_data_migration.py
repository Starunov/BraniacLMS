# Generated by Django 3.2.16 on 2022-11-25 07:38
...
def forwards_func(apps, schema_editor):
    ...
    News.objects.create(
        ...
        preamble="Мы рады Вам сообщить о запуске нового курса по Python для \
                начинающих!",
    ...
    News.objects.create(
        ...
        preamble="Всем, кто не успел купить курс в понедельник, настоятельно \
    ...
    News.objects.create(
        ...
        preamble="Все сотрудники подключены к Zoom, поэтому мы видим, что \
    ...
    News.objects.create(
        ...
        preamble="Дмитрий Шишмарев работает в IT-бизнесе с 2001 года.",
